...
cpsd_fit_volume <- fit_cpsd(raw_particles |> pull(V_um3),
                           bin_um = 1e2,
                           fit_range_um = c(1e7,1e8),#c(fragment_volume_lod_lower, fragment_volume_lod_upper),
                           lower_lod_method = "mpmax",
                           lower_resid_method = "left_resid",
                           N_min_lowbias = 3,
                           min_nonzero_tail_lowbias = 1,
...
cat(crayon::blue("All Shape Volume: alpha =", signif(cpsd_fit_volume$a_cpsd,2), "+-", signif(cpsd_fit_volume$se_a_cpsd,2), ", lower LOD =", signif(cpsd_fit_volume$lower_lod_used_um,2), ", upper LOD =", signif(cpsd_fit_volume$upper_lod_um,2), "\n"))
```
...
cat(crayon::blue("All Shape Sediment Area: alpha =", signif(cpsd_fit_area_sed$a_cpsd,2), "+-", signif(cpsd_fit_area_sed$se_a_cpsd,2), ", lower LOD =", signif(cpsd_fit_area_sed$lower_lod_used_um,2), ", upper LOD =", signif(cpsd_fit_area_sed$upper_lod_um,2), "\n"))
```
...
cat(crayon::blue("Sediment All Shape Volume: alpha =", signif(-cpsd_fit_volume_sed$a_cpsd,2), "+-", signif(cpsd_fit_volume_sed$se_a_cpsd,2), ", lower LOD =", signif(cpsd_fit_volume_sed$lower_lod_used_um,2), ", upper LOD =", signif(cpsd_fit_volume_sed$upper_lod_um,2), "\n"))
```
